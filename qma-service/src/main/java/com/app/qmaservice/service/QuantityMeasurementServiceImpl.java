...
import com.app.qmaservice.exception.QuantityMeasurementException;
import com.app.qmaservice.dto.QuantityDTO;
import com.app.qmaservice.dto.QuantityMeasurementDTO;
import com.app.qmaservice.entity.QuantityMeasurementEntity;
import com.app.qmaservice.model.QuantityModel;
import com.app.qmaservice.repository.QuantityMeasurementRepository;
import com.app.qmaservice.unit.IMeasurable;
...
public class QuantityMeasurementServiceImpl implements IQuantityMeasurementService {
    ...
    public QuantityMeasurementDTO convert(QuantityDTO thisQuantityDTO, QuantityDTO targetUnitDTO) {
        ...
        try {
            double result = (source.getUnit() instanceof com.app.qmaservice.unit.TemperatureUnit)
    ...
    private IMeasurable getModelUnit(String measurementType, String unit) {
        switch (measurementType) {
            case "LengthUnit":      return com.app.qmaservice.unit.LengthUnit.valueOf(unit);
            case "WeightUnit":      return com.app.qmaservice.unit.WeightUnit.valueOf(unit);
            case "VolumeUnit":      return com.app.qmaservice.unit.VolumeUnit.valueOf(unit);
            case "TemperatureUnit": return com.app.qmaservice.unit.TemperatureUnit.valueOf(unit);
